...
# Panel A: Flowchart — arrows pointing DOWNWARD
...
for i, (s, c) in enumerate(zip(steps, colors)):
    ...
    # Arrow from BOTTOM of this box DOWN to next box
    if i < 4:
...
gs = fig.add_gridspec(2, 2, height_ratios=[0.42, 0.58], width_ratios=[0.55, 0.45],
...
fig.text(0.03, 0.465, 'B  Per-Class Top-5 Dipeptide Features (SHAP Importance)',
